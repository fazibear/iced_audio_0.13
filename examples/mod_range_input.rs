...
use iced::{
    ...
    Alignment, Element, Length, Result, Size,
};
use iced_audio::{
    style::mod_range_input, FloatRange, HSlider, Knob, ModRangeInput, ModulationRange, Normal,
    NormalParam, VSlider,
};

fn main() -> Result {
    application(
        "ModRangeInput Example",
        ModRangeInputExample::update,
        ModRangeInputExample::view,
    )
...
pub struct ModRangeInputExample {
...
impl Default for ModRangeInputExample {
    fn default() -> Self {
...
impl ModRangeInputExample {
    ...
    fn view(&self) -> Element<Message> {
        ...
        let auto_input2 = ModRangeInput::new(self.auto_input2_param, Message::ModRangeInput2)
            .size(Length::from(15))
            .style(mod_range_input::ModRangeInput::Invisible);
        ...
        let knob_row = row![
            column![
                ...
                text("Range End"),
                knob_end,
                checkbox("Show Modulation", self.mod_range_toggle_value)
